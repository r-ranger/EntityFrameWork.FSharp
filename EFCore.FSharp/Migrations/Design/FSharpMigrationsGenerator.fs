...
type FSharpMigrationsGeneratorDependencies
    ...
    member _.FSharpHelper = fSharpHelper

    member _.FSharpMigrationOperationGenerator =
        fSharpMigrationOperationGenerator

    member _.FSharpSnapshotGenerator = fSharpSnapshotGenerator
...
type FSharpMigrationsGenerator
    ...
    override this.GenerateSnapshot
        (
